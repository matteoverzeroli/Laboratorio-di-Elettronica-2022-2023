...
\begin{table}[h!]
	...
	\end{tabular}
	\caption{Valori nominali e misurati delle resistenze utilizzate nel circuito. Il valore di R\sub{3} è la risultate del parallelo di due resistenze da \SI{24}{\kilo\ohm}.}
