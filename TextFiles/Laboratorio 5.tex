...
\clearpage
Il quarto circuito realizzato permette di superare i limiti sul settaggio del valore minimo e massimo del duty-cycle presenti nel circuito precedente.
...
In figura \ref{label} sono riportate delle acquisizioni eseguite con il trimmer impostato su diversi valori.
...
\begin{figure}[tbh]
	...
	\end{minipage}
	\begin{minipage}{.496\textwidth}
		\includegraphics[width=\linewidth]{./ImageFiles/Laboratorio 5/TEK00033.PNG}
	\end{minipage}
	\includegraphics[width=.496\textwidth]{./ImageFiles/Laboratorio 5/TEK00034.PNG}
...
\clearpage
\todo{Descrivere il compito per casa e come lo si è realizzato.}
\begin{figure}[tbh]
	\centering
