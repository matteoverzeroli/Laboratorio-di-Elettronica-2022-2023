...
\noindent
Successivamente, si sono effettuate misure del duty-cycle e della frequenza del segnale ottenuto variando il valore delle resistenze $R_A$ ($R_B$ mantenuta constante con valore di \SI{12}{\kilo\ohm}) e della capacità $C$. I dati ottenuti sono stati riportati nella figura \ref{fig:circuito_3_plot}.\todo{Descrivere quello che si osserva nelle immagini}
\begin{figure}[tbh]
	\centering
	\begin{minipage}{.496\textwidth}
