...
\begin{figure}[h!]
	...
	\end{minipage}
	\caption{Schema circuitale e foto circuito realizzato.}
	\label{fig:circuito}
\end{figure}
...
\end{figure} 
\todo{da rivedere i valori di offset non trovo la legenda delle immagini.}
