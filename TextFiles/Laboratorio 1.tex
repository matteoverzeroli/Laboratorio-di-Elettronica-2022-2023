...
\begin{itemize}
	...
	\item osservando il diagramma di Bode della fase si può notare che, in corrispondenza della frequenza di taglio, la fase è aumentata di circa 45$^{\circ}$rispetto alle frequenza più basse, mentre una decade dopo la frequenza di taglio raggiunge i -90$^{\circ}$. \todo{inserire punitini acquisizioni nei grafici}
\end{itemize}
...
\todo{aggiungere la parte offset+saturazione ultime immagini}
