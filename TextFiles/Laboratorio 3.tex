...
\noindent
Se volessimo variare il \textit{duty-cycle} del segnale in uscita al circuito, si potrebbe sbilanciare l'alimentazione positiva e negativa dell'amplificatore operazionale. Di conseguenza, variano anche le soglie ed è possibile modificare gli intervalli di carica e scarica del condensatore e quindi gli intervalli T\sub{1} e T\sub{2}. Nella figura \Fig\ref{fig:tensioni_sbilanciare} è possibile vedere che il \textit{duty-cycle} si modifica da \SI{48.01}{\percent} a \SI{55.12}{\percent}.
\begin{figure}[h]
	\centering
