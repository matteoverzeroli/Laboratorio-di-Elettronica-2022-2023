...
\end{itemize}
Di conseguenza, questo circuito rettifica entrambe le semionde e elimina il problema dello \text{shift} di tensione causato dalla tensione di polarizzazione del diodo. Nella figura \ref{fig:uscita_circuito_1} è possibile verificare il comportamento del circuito.
\begin{figure}[tbh]
	\centering
